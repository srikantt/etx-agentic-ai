...
def run_agent(pod_name, namespace):
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'srikantt', repo 'etx-agentic-ai', "
